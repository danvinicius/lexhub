import { IActor, IException, IResource, IRestriction, IScenario, ISymbol } from "@/domain/entities";
import { ScenarioRepository, SymbolRepository } from "@/data/protocols/db";
import { GetScenarioWithLexicons, FoundLexicon } from '@/domain/use-cases/scenario'
import { NotFoundError } from "@/presentation/errors/not-found-error";

export class DbGetScenarioWithLexicons implements GetScenarioWithLexicons {
